    ...
    <section id="about" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Education */}
          <div className="glass-card glow-hover animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Career Goal */}
          <div className="glass-card glow-hover animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center mb-4">
          ...
          {/* Fun Facts */}
          <div className="glass-card glow-hover animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <div className="flex items-center mb-4">
